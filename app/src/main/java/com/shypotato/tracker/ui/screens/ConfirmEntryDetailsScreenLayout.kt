...
import com.shypotato.tracker.data.helpers.toDateInMilliSecs
...
import com.shypotato.tracker.model.domain.ConfirmEntryDetailsIntent.DismissDate
import com.shypotato.tracker.model.domain.ConfirmEntryDetailsIntent.DismissTime
import com.shypotato.tracker.model.domain.ConfirmEntryDetailsIntent.UpdateDate
import com.shypotato.tracker.model.domain.ConfirmEntryDetailsIntent.UpdateTime
import com.shypotato.tracker.ui.screens.core.DateDialog
import com.shypotato.tracker.ui.screens.core.TimeDialog
    ...
    Column(
        ...
        Column(
            ...
            Row(
                ...
                OutlinedCard(
                    ...
                    onClick = { onUserEvent(ConfirmEntryDetailsIntent.OpenDate) }
                ) {
                    Text(
                        modifier = Modifier
                            .padding(8.dp),
            ...
            Row(
                ...
                OutlinedCard(
                    modifier = Modifier.heightIn(48.dp),
                    onClick = { onUserEvent(ConfirmEntryDetailsIntent.OpenTime) }
                ) {
                    Text(
                        modifier = Modifier
                            .padding(8.dp),
        ...
        Column(
            ...
            Button(
                modifier = Modifier
                    .fillMaxWidth(),
                onClick = { onUserEvent(ConfirmEntryDetailsIntent.Submit) },
            ...
            if (detailsData.canDelete) {
                OutlinedButton(
                    modifier = Modifier.fillMaxWidth(),
                    enabled = true,
                    onClick = { onUserEvent(ConfirmEntryDetailsIntent.Delete) },
